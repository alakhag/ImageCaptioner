...
cmd:option('-image', '', 'Image to caption')
...
loader = DataLoaderRaw{image = opt.image, coco_json=opt.coco_json}
-- print("test")
-------------------------------------------------------------------------------
...
local function eval_split(split, evalopt)
  ...
  local img = loader:getBatch{batch_size = opt.batch_size, split = split, seq_per_img = opt.seq_per_img}
  -- print("test")
  local img = net_utils.prepro(img,false,opt.gpuid >= 0)
